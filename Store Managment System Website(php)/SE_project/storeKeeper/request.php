...
<div>
   ...
   <div id="table_view">
   <label for="table">These are items requested by the user.</label>
             ...
             <table id="table123" class="table table-hover">
               ...
               <div id="buttons">
               <div id="button"><a href="#myDemoModal" role="button" class="btn btn-large btn-success" data-toggle="modal" onclick="callPHP()">Approve Request</a> </div>  </div>
