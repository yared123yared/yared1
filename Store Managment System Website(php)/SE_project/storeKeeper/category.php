    ...
    <div id="head" class="bg-primary row-5 col">
        ...
        <ul>
           ...
           <table id="table123" class="table table-hover">
              ...
              <div id="button"><a href="#myDemoModal" role="button" class="btn btn-large btn-success" data-toggle="modal">Add Category</a> </div>
              <div id="button"><a href="#myDemoModal" role="button" class="btn btn-large btn-success" data-toggle="modal">Remove Category</a> </div>
              </div>
              <?php   include('addCategoryDialog.php'); ?>
