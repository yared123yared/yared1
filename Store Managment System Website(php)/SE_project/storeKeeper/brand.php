    ...
    <div id="head" class="bg-primary row-5 col">
        ...
        <div id="left">
            ...
            <table id="table123" class="table table-hover">
               ...
               <div id="buttons">
               <div id="button"><a href="#myDemoModal" role="button" class="btn btn-large btn-success" data-toggle="modal">Add Brand</a> </div>
               <div id="button"><a href="#myDemoModal" role="button" class="btn btn-large btn-success" data-toggle="modal" onclick="callPHP()">Remove Brand</a> </div>
               </div>
               <?php   include('addBrandDialog.php'); ?>
