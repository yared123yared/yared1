...
<body>
    ...
    <div id="body">
        ...
        <div id="left">
            ...
            <label for="table"> These are the item in the store that haven't assighned for users(free items).</label>
            <div id="table_view">
                <div>           
            <table id="table123" class="table table-hover" >
               ...
               <div id="buttons">
                 <div id="button"><a href="#myDemoModal" role="button" class="btn btn-large btn-success" data-toggle="modal" onclick="request()">Request For Item</a> </div>
               </div>
