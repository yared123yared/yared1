...
<body>
    ...
    <div id="body">
        ...
        <div id="left">
            ...
            <label for="table">The follwoing are the item assighned for you as you requested. you can take</label>
            <div id="table_view">
                <div>
            ...
            <table id="table123">
               ...
               <div id="button"><a href="#myDemoModal" role="button" class="btn btn-large btn-success" data-toggle="modal" onclick="take()">Take Selected Item</a> </div>
             <?php   
