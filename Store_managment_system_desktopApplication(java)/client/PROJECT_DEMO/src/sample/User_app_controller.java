...
public class User_app_controller implements Initializable {
    ...
    public void logout(ActionEvent event) throws IOException {
        ...
        Parent inner = FXMLLoader.load(getClass().getResource("ASHEE.fxml"));
    ...
    public void notfiedOnAction(javafx.event.ActionEvent event) throws IOException {
        FXMLLoader fXMLLoader = new FXMLLoader();
        fXMLLoader.load(getClass().getResource("userNotyfiedItem.fxml").openStream());
        //Parent root= FXMLLoader.load(getClass().getResource("store_keeper.fxml"));
        //homepane.setCenter(root);
        BorderPane bp = fXMLLoader.getRoot();
        bp.setMaxSize(2500, 700);
