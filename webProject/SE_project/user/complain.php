...
<body>
    ...
    <div id="body">
        ...
        <div id="left">
            ...
            <label for="table">These are the complains you have submited recently you can add more.</label>
                <div id="table_view">
                <div>   
               ...
               <div id="buttons">
                 <div id="button"><a href="#myDemoModal" role="button" class="btn btn-large btn-success" data-toggle="modal">Complain For Item</a> </div>
               </div>
               <?php   include('complain_form.php'); ?>
